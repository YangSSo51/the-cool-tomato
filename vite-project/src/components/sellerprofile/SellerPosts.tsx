...
export default function SellerPosts() {
    const photos = [
        ...
        { id: 2, title: "Photo 2", src: "https://img.seoul.co.kr/img/upload/2023/06/13/SSC_20230613163553_O2.png" },
        { id: 3, title: "Photo 3", src: "https://cdn.imweb.me/upload/S201807025b39d1981b0b0/5cac274d00b12.jpg" },
        // ... 추가적인 사진 데이터 추가
      ];
    return (
        <>
