...
public class BlockManageController {
    ...
    public ResponseEntity<SuccessResponse<?>> addFollow(HttpServletRequest httpServletRequest, @NotNull(message = "차단할 회원 ID를 입력해 주세요.") @PathVariable(name = "blocked-id") Long blockedId) {
    ...
    @Operation(summary = "차단 삭제", description = "판매자는 구매자 ID로 구매자를 차단을 취소 합니다.")
    public ResponseEntity<SuccessResponse<?>> removeFollow(HttpServletRequest httpServletRequest, @NotNull(message = "차단할 회원 ID를 입력해 주세요.") @PathVariable(name = "blocked-id") Long blockedId) {
